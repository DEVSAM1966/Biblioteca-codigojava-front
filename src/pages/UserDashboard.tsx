...
const UserDashboard = () => {
  ...
  // Cambiado el filtro de libros para las busquedas
    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Welcome to Library CodigoJava</h1>
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {books
              ...
              .map((book, index) => {
                const borrowRecord = borrowedBooks.find((record) => record.bookId === book.isbn);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {filteredBooks.map((book, index) => (
              <motion.div
                ...
                onClick={() => setSelectedBook(selectedBook?.isbn === book.isbn ? null : book)}
              >
                <div className="flex flex-col md:flex-row">
                  {/* Book Cover */}
                  <div className="relative w-full md:w-1/3">
